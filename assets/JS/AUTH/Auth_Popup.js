...
function Signup_content() {
    let form_signup = `<p>Create your profile!</p>
                       <form method="post" id="contact" autocomplete="on">
                            ...
                            <p class="m-0"><input type="checkbox" name="CGU" id="CGU" placeholder="CGU" required>I read and accept the <a id="CGU_link" href="https://decommissionvn.github.io/lesThesEmilieBackup/CGU/Cgu.html" alt="CGU Trois-Fils">CGU<a/></p>
