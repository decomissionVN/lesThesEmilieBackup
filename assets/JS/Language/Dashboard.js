...
function language_used(){
    ...
    if (language === 'fr'){
        let translation = {
            ...
            Title_Page : "Les thés d'Emilie | Thés en ligne Twinings | Mon espace",
            ...
            YourSelection : "Votre espace personnel",
            tea_choice : "Découvrez tous nos thés!",
            History : "Un aperçu de mes préférences",
            Our_tea : "Nos thés",
        ...
        let translation = {
            ...
            Title_Page : "Les thés d'Emilie | Online tea shop - Twinings | Dashboard",
            ...
            YourSelection : "Your personal Dashboard",
            tea_choice : "Discover all our teas!",
            History : "A little preview of your tastes",
        }
...
function insert_the_HTML(translation){
    document.getElementById('YourSelection').innerHTML = translation.YourSelection;
...
function User_exists(translation) {
    ...
    if (token && userId) {
        fetch('https://api.lesthesdemilie.net/api/orders/orderGet' + '/' + userId.userId, { method: "GET", headers: { 'Authorization': 'bearer ' + token.token_access }}).then(response => response.json()).then(response => display_order(response, translation))
    ...
    if (response.length !== 0){
        ...
        orderlist.forEach(Order => {
            ...
            <div class="row w-100 grey_bg_white">
                <div class="col-md-6 mb-5">
                    ...
                    <div class="col-12 text-center mb-5">
                        <a class="button ${Order._status}" href="#" onclick="PaymentorderId('${Order._productId}','${Order.__id}')">${translation.Finalize}</a>
                    </div>
                </div>
            ...
            <div class="w-100 m-auto text-center pt-2 mb-5">
                <img src="../assets/IMAGES/HOME/Separation.png" class="pb-3 Separator">
            </div>
...
function PaymentorderId(orderId, _Id) {
        event.preventDefault();
        let queryParams = new URLSearchParams(window.location.search);
            queryParams.set("ProductId", orderId);
            queryParams.set("OrderId", _Id);
