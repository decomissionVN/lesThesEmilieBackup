...
function language_used(){
    ...
    if (language === 'fr'){
        let translation = {
            ...
            Title_Page : "Les Thés d'Emilie | Mes commandes",
            ...
            Title_Cart : "Le détail de mes commandes",
            Our_tea : "Nos thés",
            Accessoires : "Le coins des accessoires",
            Souvenirs : "Un petit souvenir",
            myOrders_title : "Toutes mes commandes",
            cart_choice : "Le détail de mes commandes",
            tea_choice : "Discover our selection of tea!",
        ...
        let translation = {
            ...
            Title_Page : "Les thés d'Emilie | My orders | Online tea & Twinings",
...
function insert_the_HTML(translation){
    ...
    document.getElementById('myOrders_title').innerHTML = translation.myOrders_title;
...
function User_exists(translation) {
    ...
    if (token && userId) {
        fetch('https://api.lesthesdemilie.net/api/orders/orderGetPaid' + '/' + userId.userId, { method: "GET", headers: { 'Authorization': 'bearer ' + token.token_access }}).then(response => response.json()).then(response => display_order(response, translation))
