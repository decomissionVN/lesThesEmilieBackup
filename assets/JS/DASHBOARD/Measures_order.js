    ...
    if (token == null || userId == null){
        document.getElementById('Measures_article').innerHTML = `<h2 class="pb-3 pt-3">You are not connected!</h2>
                                                            ...
                                                            <form method="post" id="contact_measures" autocomplete="on">
                                                                    ...
                                                                    <p class="m-0"><input type="checkbox" name="CGU" id="CGU_measures" placeholder="CGU" required> I read and accept the <a id="CGU_link" href="../CGU/Cgu.html" alt="CGU Trois-Fils">CGU<a/></p>
...
function display_measure_saved(response) {
    ...
    if (response_json.message === 'measures not taken') {
        ...
        window.location.replace('../../HTML/LADIES/Appointment_measures.html');
                                                              ...
                                                              <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                                                                    <div class="carousel-inner">
                                                                        ...
                                                                        <div class="carousel-item">
                                                                            <img class="d-block w-100" src="../../IMAGES/HOME/Carroussel-home1.jpg" alt="Second slide">
                                                                            <div class="carousel-caption">

                                                                            </div>
                                                                        </div>
                                                                        <div class="carousel-item">
                                                                            <img class="d-block w-100" src="../../IMAGES/HOME/Carroussel-home1.jpg" alt="Third slide">
                                                                            <div class="carousel-caption">
    ...
    document.getElementById('Measures_form_units').innerHTML = `<div class="col-md-10 offset-md-1 mt-auto mb-auto text-center" data-aos="fade-up" data-aos-easing="ease-out" data-aos-duration="1000">
                                                              ...
                                                              <ul>
                                                                    <li id="Measures_Advise1">
                                                                        <img src="../../IMAGES/DASHBOARD/Calendar.png" alt="Tailoring profile" />
                                                                        <p>Empty your pockets</p>
                                                                    </li>
                                                                    <li id="Measures_Advise2">
                                                                        <img src="../../IMAGES/DASHBOARD/Simulator.png" alt="Tailoring profile" />
                                                                        <p>Keep your clothes on, preferably an adjusted shirt</p>
                                                                    </li>
                                                                    <li id="Measures_Advise3">
                                                                        <img src="../../IMAGES/DASHBOARD/Messages.png" alt="Tailoring profile" />
...
function Take_Measures_fetch(response) {
    ...
    console.log('INSIDE THE TAKE.MEASURES');
        ...
        display_current_step('1', 'Shoulders');
            document.getElementById('units_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_Units()">You are using ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure1_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('1', 'Measure')">Measure1 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
        ...
        display_current_step('2', 'Arms');
            document.getElementById('units_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_Units()">You are using ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure1_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('1', 'Measure')">Measure1 is ${response_json.measure1} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure2_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('2', 'Measure')">Measure2 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
        ...
        display_current_step('3', 'Stomack');
            document.getElementById('units_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_Units()">You are using ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure1_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('1', 'Measure')">Measure1 is ${response_json.measure1} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure2_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('2', 'Measure')">Measure2 is ${response_json.measure2} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure3_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('3', 'Measure')">Measure3 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
        ...
        display_current_step('4', 'Shoulders');
            ...
            document.getElementById('measure1_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('1', 'Measure')">Measure1 is ${response_json.measure1} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure2_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('2', 'Measure')">Measure2 is ${response_json.measure2} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure3_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('3', 'Measure')">Measure3 is ${response_json.measure3} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure4_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('4', 'Measure')">Measure4 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('5', 'Belly');
            ...
            document.getElementById('measure2_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('2', 'Measure')">Measure2 is ${response_json.measure2} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure3_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('3', 'Measure')">Measure3 is ${response_json.measure3} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure4_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('4', 'Measure')">Measure4 is ${response_json.measure4} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure5_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('5', 'Measure')">Measure5 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('6', 'Stomach');
            ...
            document.getElementById('measure3_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('3', 'Measure')">Measure3 is ${response_json.measure3} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure4_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('4', 'Measure')">Measure4 is ${response_json.measure4} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure5_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('5', 'Measure')">Measure5 is ${response_json.measure5} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure6_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('6', 'Measure')">Measure1 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('7', 'Stomach');
            ...
            document.getElementById('measure4_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('4', 'Measure')">Measure4 is ${response_json.measure4} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure5_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('5', 'Measure')">Measure5 is ${response_json.measure5} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure6_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('6', 'Measure')">Measure1 is ${response_json.measure6} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure7_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('7', 'Measure')">Measure2 is ... ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('8', 'Stomach');
            ...
            document.getElementById('measure5_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('5', 'Measure')">Measure5 is ${response_json.measure5} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure6_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('6', 'Measure')">Measure1 is ${response_json.measure6} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure7_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('7', 'Measure')">Measure2 is ${response_json.measure7} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure8_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('8', 'Measure')">Measure3 is ${response_json.measure8} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('9', 'Stomach');
            ...
            document.getElementById('measure7_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('7', 'Measure')">Measure2 is ${response_json.measure7} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure8_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('8', 'Measure')">Measure3 is ${response_json.measure8} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure9_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('9', 'Measure')">Measure4 is ${response_json.measure9} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('10', 'Stomach');
            ...
            document.getElementById('measure8_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('8', 'Measure')">Measure3 is ${response_json.measure8} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure9_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('9', 'Measure')">Measure4 is ${response_json.measure9} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure10_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('10', 'Measure')">Measure5 is ${response_json.measure10} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('11', 'Stomach');
            ...
            document.getElementById('measure9_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('9', 'Measure')">Measure4 is ${response_json.measure9} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure10_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('10', 'Measure')">Measure5 is ${response_json.measure10} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure11_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('11', 'Measure')">Measure5 is ${response_json.measure11} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('12', 'Stomach');
            ...
            document.getElementById('measure10_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('10', 'Measure')">Measure5 is ${response_json.measure10} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure11_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('11', 'Measure')">Measure5 is ${response_json.measure11} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure12_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('12', 'Measure')">Measure5 is ${response_json.measure12} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('13', 'Stomach');
            ...
            document.getElementById('measure11_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('11', 'Measure')">Measure5 is ${response_json.measure11} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure12_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('12', 'Measure')">Measure5 is ${response_json.measure12} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure13_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('13', 'Measure')">Measure5 is ${response_json.measure13} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    }
        ...
        display_current_step('14', 'Stomach');
            ...
            document.getElementById('measure12_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('12', 'Measure')">Measure5 is ${response_json.measure12} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure13_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('13', 'Measure')">Measure5 is ${response_json.measure13} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure14_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('14', 'Measure')">Measure5 is ${response_json.measure14} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
        ...
        display_current_step('15', 'Stomach');
            ...
            document.getElementById('measure13_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('13', 'Measure')">Measure5 is ${response_json.measure13} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure14_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('14', 'Measure')">Measure5 is ${response_json.measure14} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
            document.getElementById('measure15_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('15', 'Measure')">Measure5 is ${response_json.measure15} ${response_json.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
...
function Display_Measures(measures) {
    ...
    console.log(Measures);
    document.getElementById('units_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_Units()">You are using ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure1_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('1', 'Measure')">Measure1 is ${Measures.measure1} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure2_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('2', 'Measure')">Measure2 is ${Measures.measure2} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure3_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('3', 'Measure')">Measure3 is ${Measures.measure3} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure4_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('4', 'Measure')">Measure4 is ${Measures.measure4} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure5_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('5', 'Measure')">Measure5 is ${Measures.measure5} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure6_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('6', 'Measure')">Measure6 is ${Measures.measure6} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure7_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('7', 'Measure')">Measure7 is ${Measures.measure7} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure8_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('8', 'Measure')">Measure8 is ${Measures.measure8} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure9_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('9', 'Measure')">Measure9 is ${Measures.measure9} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure10_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('10', 'Measure')">Measure3 is ${Measures.measure10} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure11_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('11', 'Measure')">Measure4 is ${Measures.measure11} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure12_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('12', 'Measure')">Measure5 is ${Measures.measure12} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure13_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('13', 'Measure')">Measure6 is ${Measures.measure13} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure14_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('14', 'Measure')">Measure7 is ${Measures.measure14} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
    document.getElementById('measure15_label').innerHTML = `<a href="#" class="text-center width100" onclick="Display_Step_measure('15', 'Measure')">Measure7 is ${Measures.measure15} ${Measures.unity}</a><img src="../../IMAGES/GENERAL/ok.png" alt="Measure OK">`;
